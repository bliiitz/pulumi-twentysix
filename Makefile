PROJECT_NAME := Pulumi Twenty Six Cloud Resource Provider

PACK             := twentysix
PACKDIR          := sdk
PROJECT          := github.com/bliiitz/pulumi-twentysix
...
prepare::
	...
	@if test ! -d "provider/cmd/pulumi-twentysix"; then "Project already prepared"; exit 1; fi # SED_SKIP
